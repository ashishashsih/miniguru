...
class AppProfileView extends GetView<AppProfileController> {
  ...
  {
    AppProfileController controller=Get.put(AppProfileController());
    ...
    Widget settingsWidget({required GestureTapCallback onTap,
                ...
                return Column(
                  children: [
                    ...
                    Align(
                      ...
                      child: Text(controller.studentName.value, style: titleStyle),
                    ),
                    SizedBox(height: size.width * 0.02),
                    Align(
                      alignment: Alignment.center,
                      child: Text(controller.email.value, style: subTitle),
                    ),
                    SizedBox(height: size.width * 0.05),
                    Row(
