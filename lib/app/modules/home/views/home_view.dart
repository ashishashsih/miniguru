      ...
      children: [
        Column(
          ...
          children: const [
            ...
            Text('John Smith 👋', style: titleStyle),
          ],
        ),
        //Notifications
        Align(
          ...
          child: Row(
            children: [
              ...
              InkWell(
                onTap: () => Get.to(()=>NotificationView(),transition: Transition.rightToLeftWithFade),
                child: const Center(
                                        ...
                                        Column(children: [
                                          const Text('Score',
                                              style: TextStyle(fontSize: 20,
                                                  ...
                                                  letterSpacing: 1)),
                                          Text(
                                              controller.score.value, style:const  TextStyle(fontSize: 15,
                                              color: Colors.white,
                                              fontWeight: FontWeight.bold,
                                              letterSpacing: 0.5)),
                                        ],)
                                          ...
                                          SizedBox(
                                            ...
                                            child: TextFormField(
                                              ...
                                              decoration: InputDecoration(
                                                ...
                                                labelStyle: const TextStyle(color: Colors.white,letterSpacing: 1,fontSize: 15),
                                            ...
                                            Expanded(
                                              ...
                                              child: InkWell(
                                                onTap: (){
                                                  ...
                                                  homeController.coinAnimationController.play();
                                                  Get.back();
                                                },
                                                child: Container(
                                                  height: size.width * 0.1,
